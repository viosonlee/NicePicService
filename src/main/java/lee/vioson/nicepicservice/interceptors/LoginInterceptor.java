package lee.vioson.nicepicservice.interceptors;
...
//        //    response.sendRedirect(ResultUtils.error(ResultStatus.UNLOGIN).toString());
//          //  response.sendError(201, "未登录");
//            throw new LoginException(ResultStatus.UNLOGIN);
//        }
        return true;
    }
